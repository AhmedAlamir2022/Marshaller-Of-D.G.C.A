...
<html lang="en">
    <head>
        ...
        <title>Employee Login - Marshaller of D.G.C.A</title>
        <!-- Favicon -->
                ...
                <div class="container">
                    <div class="row justify-content-center no-gutters vertical-align">
                        <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                            style="background-image: url('{{ URL::asset('frontend/images/faq-5.png')}}');">
                            <div class="login-fancy">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 bg-white">
                            <div class="login-fancy pb-40 clearfix">
                                <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">Employee Login</h3>
