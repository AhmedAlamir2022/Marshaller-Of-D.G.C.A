...
<html lang="en">
    <head>
        <title>Contact Messages - Marshaller of D.G.C.A</title>
        <meta charset="utf-8">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="page-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;"> Contact Messages List</h4>
                        </div>
                        <div class="col-sm-6">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('delete.message',$contact->id) }}" method="post">
                                                                    @csrf
