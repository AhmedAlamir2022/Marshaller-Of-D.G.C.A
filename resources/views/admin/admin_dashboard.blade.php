...
<html lang="en">
<head>
    <title>Admin Dashboard - Marshaller of D.G.C.A</title>
    <meta charset="utf-8">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">Arrival Plans</p>
                                    <h4>{{ \App\Models\Plans::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-bookmark-o mr-1" aria-hidden="true"></i> Total Arrival Plans
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">Gallary Images</p>
                                    <h4>{{ \App\Models\Gallary::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-calendar mr-1" aria-hidden="true"></i> Total Gallary Images
                            </p>
                        </div>
                    </div>
                </div>
